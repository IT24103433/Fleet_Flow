  ...
  return (
    <aside className={`staff-sidebar ${sidebarCollapsed ? 'collapsed' : ''}`}>
      ...
      <nav className="staff-sidebar-nav" aria-label="Staff Navigation">
        ...
        <button
          type="button"
          className={`staff-nav-item ${currentView === 'maintenance-dashboard' ? 'active' : ''}`}
          onClick={() => onNavigate('maintenance-dashboard')}
          title="Maintenance & Telematics Dashboard"
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="nav-item-icon">
            <path strokeLinecap="round" strokeLinejoin="round" d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
          </svg>
          {!sidebarCollapsed && <span className="nav-item-label">Maintenance</span>}
        </button>
